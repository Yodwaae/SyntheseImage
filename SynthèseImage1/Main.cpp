...
int main()
{
    ...
    Sphere rightWallSphere{Point(wallSphereRadius + 475, 250, 0), wallSphereRadius, Color(0, 255, 0) };
    Sphere leftWallSphere{Point(-wallSphereRadius + 25, 250, 0), wallSphereRadius, Color(255, 0, 0) };
    Sphere upWallSphere{Point(250, -wallSphereRadius + 25, 0), wallSphereRadius, Color(255, 255, 255) };
    Sphere downWallSphere{Point(250, wallSphereRadius + 475, 0), wallSphereRadius, Color(255, 255, 255) };
    Sphere backWallSphere{Point(250, 250, 500 +wallSphereRadius), wallSphereRadius, Color(255, 255, 255) };

    // Spheres creation
    Sphere sphere1{ Point(250, 250, 300), 200, Color(255, 255, 255) };
    Sphere sphere2{ Point(0, 250, 300), 100, Color(255, 255, 255) };

    // Sphere vector
    vector<Sphere> spheres = { rightWallSphere, leftWallSphere, upWallSphere, downWallSphere, backWallSphere, sphere1, sphere2 };

    // Light creation
    Light light{ Point(250, 250, 0) };
